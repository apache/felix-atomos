...
public class ReflectionBundleActivatorPlugin implements BundleActivatorPlugin<Config>
{
        ...
        ClassLoader classLoader)
    {
        ...
        try
        {
            ...
            context.addReflectionConstructor(bundleActivatorClass, new Class[] {});

            context.addReflecionMethod("start", new Class[] { bundleContextClass },
                bundleActivatorClass);
            context.addReflecionMethod("stop", new Class[] { bundleContextClass },
                bundleActivatorClass);
        }
